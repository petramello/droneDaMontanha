  ...
  return (
    <OverHiddenContainer>
      ...
      <GalleryContainer marginGalleryContainer="40px -95px 40px 125px">
        <MidiaTitle
          paddingMidiaTitle="35px 0 5px 7px"
          fontsizeMidiaTitleSmall="0.5em"
          letterspacingMidiaTitleSmall="2px"
        >
          ISSO É BRASIL. Serras Gerais\TO\Brasil
        </MidiaTitle>
        ...
        <MidiaTitle
          ...
          letterspacingMidiaTitleSmall="2px"
        >
          MONTANHAS DO BRASIL. Demo Reel-2016\Brasil
        </MidiaTitle>
